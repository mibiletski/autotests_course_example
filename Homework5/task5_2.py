...
def repeats(our_str):
    """
    Функция принимает на вход строку. Смотрит, сколько раз в ней каждый символ уже встречался, и добавляет количество
    к символам с помощью постфикса формата _n. Возвращается новая строка.
    :param our_str:
    :return: new_str
    """
