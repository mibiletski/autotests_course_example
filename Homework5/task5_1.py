...
def letter_stat(our_str):
    """
    Функция принимает на вход строку our_str и возвращает словарь, где в качестве ключей буквы строки, а значениями
    являются числа, соответствующие количеству вхождений данной буквы в строку.
    :param our_str:
    :return:letters_dict
    """
